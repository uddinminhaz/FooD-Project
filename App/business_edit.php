					...
					<table align="center" >
						<tbody>
							...
							<tr>
								...
								<td colspan="3" align="center"><input type="submit" class="regbut"value="update"/></td>
							</tr>
						</tbody>
					</table>
				</form>
	...
	if($_SERVER["REQUEST_METHOD"]=='POST'){
		...
		if($flag!=1){
			...
			include_once("../Data/dboy_access.php");
			 ...
			 $result=updatedboyall($uname,$name,$email,$mblno,$add);
...
<script>
	...
	function cancleClick(){
		window.location.href = "http://127.0.0.1/foodd_01/App/Business_Home.php";
	}
	function PasswordClick(){
		window.location.href = "http://127.0.0.1/foodd_01/App/password_business.php?uname=<?= $_SESSION['user']['uname'];?> ";
	}
</script>
