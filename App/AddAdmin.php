					...
					<table>
						...
						<tr>
							...
							<tr>
								<td><b>Type</b></td>
								<td>:</td>
								<td> admin<input Type="Hidden" value="admin" name="type"/></td>
							</tr>
							<div id="cancelbutton">
							...
							<div id="addbutton">
								 ...
								 <input name="addadmin" type="submit" class="regbut" value="Add Admin" onclick="saveClick()"/>
