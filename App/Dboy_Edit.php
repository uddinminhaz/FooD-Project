...
<script>
	...
	window.location.href = "http://127.0.0.1/foodd_01/App/Dboy_Home.php";}
			function PasswordClick(){
		window.location.href = "http://127.0.0.1/foodd_01/App/password_dboy.php?uname=<?= $_SESSION['user']['uname'];?> ";
